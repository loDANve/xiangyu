...
public class Constants {
	...
	//PacketListener
	public static final int RECEIVEMSG = 200;
	public static final int SENDMSG = 201;
	// PREFERENCE KEYS
    public static final String SHARED_PREFERENCE_NAME = "lvgouJJ";
...
//    public static final String CALLBACK_ACTIVITY_CLASS_NAME = "CALLBACK_ACTIVITY_CLASS_NAME";
    ...
    public static final String XMPP_RESOURCE_NAME = "Android";
